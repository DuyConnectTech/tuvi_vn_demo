                        ...
                        <form method="POST" action="{{ route('client.horoscopes.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ old('name', 'Tâm Như Lâm') }}" placeholder="Nhập họ tên" required>
                            </div>

                            <div class="form-group">
                                <label class="font-weight-bold d-block">Giới tính</label>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="gender_male" name="gender" class="custom-control-input"
                                        value="male" {{ old('gender', 'male') == 'male' ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="gender_male">Nam</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="gender_female" name="gender" class="custom-control-input"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="day">
                                        @for ($i = 1; $i <= 31; $i++)
                                            <option value="{{ $i }}" {{ old('day', 1) == $i ? 'selected' : '' }}>
                                                {{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="month">
                                        @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('month', 1) == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="minute">
                                        @for ($i = 0; $i <= 59; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('minute', 30) == $i ? 'selected' : '' }}>{{ $i }} phút
                                            </option>
                                        @endfor
                                    </select>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="view_year">
                                        @for ($y = date('Y') - 10; $y <= date('Y') + 10; $y++)
                                            <option value="{{ $y }}"
                                                {{ old('view_year', 2025) == $y ? 'selected' : '' }}>{{ $y }}
                                            </option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="view_month">
                                        ...
                                        @for ($m = 1; $m <= 12; $m++)
                                            <option value="{{ $m }}"
                                                {{ old('view_month') == $m ? 'selected' : '' }}>Tháng {{ $m }}
                                            </option>
                                        @endfor
                                    </select>
                                </div>
                            ...
                            <div class="form-group mt-4">
                                <button type="submit"
                                    class="btn btn-danger btn-lg btn-block font-weight-bold py-3 shadow-sm">
